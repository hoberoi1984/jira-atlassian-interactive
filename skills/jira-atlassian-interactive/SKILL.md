...
description: >
  Interactive Jira issue creation with mandatory project/space selection, ticket type selection, and specialized metadata mapping for Tasks and Changes.
---
...
2.  **Prompt for Core Ticket Details:**
    ...
    -   **Space Selection:** -   Header: "Jira Space"
